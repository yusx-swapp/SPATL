...
################################fedavg################################
def local_update(nets, selected, args, net_dataidx_map,logger, test_dl = None, device="cpu", Prune=True):
    avg_acc = 0.0
    pre_avg_acc = 0.0
    for net_id, net in nets.items():
        ...
        trainacc, testacc, pre_trainacc, pre_testacc = train_net(net_id, net, train_dl_local, test_dl_local, n_epoch, args.lr, args.optimizer, logger,args,device=device)
